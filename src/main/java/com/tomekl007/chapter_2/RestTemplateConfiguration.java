...
public class RestTemplateConfiguration {
  ...
  public RequestConfig requestConfig(int connectionTimeout,
                                     int socketTimeout) {
  ...
  public RestTemplate restTemplateCountries() {
    PoolingHttpClientConnectionManager poolingHttpClientConnectionManager =
        poolingHttpClientConnectionManager(20, 20);
    RequestConfig requestConfig =
        requestConfig(2000, 1400);
  ...
  public RestTemplate restTemplateFacebook() {
    PoolingHttpClientConnectionManager poolingHttpClientConnectionManager
        = poolingHttpClientConnectionManager(100, 100);
    RequestConfig requestConfig =
        requestConfig(1000, 700);
    CloseableHttpClient httpClient = httpClient(poolingHttpClientConnectionManager, requestConfig);
